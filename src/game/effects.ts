import { Particle, HitSpark } from './config'
...
export function updateSparks(sparks: HitSpark[]): HitSpark[] {
  return sparks
...
export function drawSparks(ctx: CanvasRenderingContext2D, sparks: HitSpark[]) {
...
export function createKoExplosion(x: number, y: number, color: string): Particle[] {
