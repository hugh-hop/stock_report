...
import { drawMecha } from './sprites.js'
import { drawParticles, drawSparks } from './effects.js'

export function render(ctx, p1, p2, particles, sparks, gameState, roundTimer, readyTimer) {
...
function drawHud(ctx, p1, p2, roundTimer) {
  const barWidth = 200
  const barHeight = 12
  const barY = 16
...
function drawReadyOverlay(ctx, readyTimer) {
